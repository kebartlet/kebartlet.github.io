...
(() => {
    ...
    var b = class {
            constructor(t, e) {
                if (this.isFocused = !1, this.canvas = t, this.nodeEl = e, this.nodeEl.nodeObj = this, this.labelEl = e.querySelector(".canvas-node-label"), this.containerEl = e.querySelector(".canvas-node-container"), this.contentEl = e.querySelector(".canvas-node-content"), !this.labelEl || !this.containerEl || !this.contentEl) return void console.error("Failed to find all required elements for canvas node", this);
        ...
        v = class {
            ...
            set backgroundScale(t) {
                ...
                this.backgroundEl?.setAttribute("width", e), this.backgroundEl?.setAttribute("height", e), this._backgroundScale = t, this.backgroundEl?.parentElement && (this.backgroundEl.parentElement.style.opacity = (1 - f(this._backgroundScale, this._backgroundBaseScale / 2, this._invisibleBackgroundScale, 0, 1)).toString())
            }
            ...
            updateScale(t) {
                ...
                var i, s, n;
                this.lastTime = t, Math.abs(this.targetScale - this.scale) > 1e-4 && (this.scale = g(this.scale, this.targetScale, 6 * e)), this.targetPosition.sub(this.position).magnitude > .001 && (this.position = (i = this.position, s = this.targetPosition, n = 6 * e, new c(g(i.x, s.x, n), g(i.y, s.y, n))));
            ...
            initEvents() {
                ...
                function s(t) {
                    const i = e.wrapperEl.getBoundingClientRect(),
                        s = t.clientX - i.left,
                        n = t.clientY - i.top;
                    return new c(s, n)
                }
                ...
                this.wrapperEl.addEventListener("pointerdown", (function(t) {
                    ...
                    function r(t) {
                        if (i && a?.isScrollable && 4 == t.buttons) return;
                        t.preventDefault();
                        const r = s(t).sub(n);
                        e.forcePosition = o.add(r)
                    }
                    document.addEventListener("mousemove", r), document.addEventListener("mouseup", (function t(e) {
                    ...
                    if (!n(t.deltaY, t.deltaX, e.focusedNode)) return;
                    let i = 1;
                    i -= t.deltaY / 700 * i, e.scaleAround(i, s(t))
                }), {
                    passive: !0
                });
                let o = !1;
                this.wrapperEl.addEventListener("touchstart", (function(t) {
                    ...
                    function a(t) {
                        const e = s(t[0]),
                            i = 2 == t.length ? s(t[1]) : null,
                            n = i ? e.add(i).scale(.5) : e;
                        return {
                            touch1: e,
                            touch2: i,
                            center: n,
                    ...
                    function d(t) {
                        ...
                        if (2 == i.length) {
                            h || (r = a(i), h = !0);
                            const t = (s.distance - r.distance) / r.distance;
                            e.scaleAround(1 + t, s.center)
                        }
                        const o = s.center.sub(r.center);
                        h || n(-o.y, o.x, l) ? (t.preventDefault(), e.targetPosition = e.targetPosition.add(o), r = a(i)) : r = a(i)
                    }
                    document.addEventListener("touchmove", d), document.addEventListener("touchend", (function t(e) {
                        document.removeEventListener("touchmove", d), document.removeEventListener("touchend", t), o = !1
                    }))
                }))
            }
            scaleAround(t, e, i = !1) {
        ...
        w = class {
            constructor(t = "#right-sidebar-content", e = "start") {
                this.selector = "#right-sidebar-content", this.type = "start", this.selector = t, this.type = e
            }
        },
        y = class {
            constructor() {
                this.featureId = "feature", this.enabled = !0, this.unavailable = !1, this.alwaysEnabled = !1, this.hideSettingsButton = !1
            }
            setAvailable(t) {
                this.unavailable = !t, this.enabled = t
            }
        },
        E = class extends y {
            constructor(t, e) {
                super(), this.featurePlacement = new w, this.featureId = t ?? "inserted-feature", this.featurePlacement = e ?? new w
            }
            insertFeature(t, e) {
                if (!t) return !1;
        ...
        S = class extends E {
            constructor() {
                super(...arguments), this.displayTitle = "Feature"
            }
        },
        _ = class extends E {
            constructor() {
        ...
        k = class extends S {
            constructor() {
                super(), this.featureId = "aliases", this.displayTitle = "Aliases", this.featurePlacement = new w(".header .data-bar", "start")
            }
        },
        L = class extends S {
            constructor() {
                super(), this.featureId = "backlinks", this.displayTitle = "", this.featurePlacement = new w(".footer", "start")
            }
        },
        x = class {};
    x.libFolderName = "site-lib", x.mediaFolderName = "media", x.scriptsFolderName = "scripts", x.cssFolderName = "styles", x.fontFolderName = "fonts", x.htmlFolderName = "html", x.metadataFileName = "metadata.json", x.searchIndexFileName = "search-index.json";
    var P = class extends _ {
            constructor() {
                super(), this.sourcePath = "", this.featureId = "custom-head", this.featurePlacement = new w("head", "end"), this.includePath = `${x.libFolderName}/${x.htmlFolderName}/custom-head.html`
            }
        },
        C = class extends y {
            constructor() {
                super(), this.allowFoldingLists = !0, this.allowFoldingHeadings = !0, this.documentWidth = "40em", this.featureId = "obsidian-document", this.alwaysEnabled = !0
            }
        },
        T = class extends _ {
            constructor() {
                super(), this.showCustomIcons = !1, this.showDefaultFolderIcons = !1, this.showDefaultFileIcons = !1, this.defaultFolderIcon = "lucide//folder", this.defaultFileIcon = "lucide//file", this.defaultMediaIcon = "lucide//file-image", this.exposeStartingPath = !0, this.featureId = "file-navigation", this.featurePlacement = new w("#left-sidebar-content", "end"), this.includePath = `${x.libFolderName}/${x.htmlFolderName}/file-tree.html`
            }
        },
        O = class extends S {
            constructor() {
                super(), this.showOrphanNodes = !0, this.showAttachments = !1, this.allowGlobalGraph = !0, this.allowExpand = !0, this.attractionForce = 1, this.linkLength = 15, this.repulsionForce = 80, this.centralForce = 2, this.edgePruning = 100, this.minNodeRadius = 3, this.maxNodeRadius = 7, this.featureId = "graph-view", this.displayTitle = "", this.featurePlacement = new w("#right-sidebar-content", "start")
            }
        },
        F = class extends y {
            constructor() {
                super(), this.featureId = "link-preview", this.hideSettingsButton = !0
            }
        },
        M = class extends S {
            constructor() {
                super(), this.startCollapsed = !1, this.minCollapseDepth = 0, this.featureId = "outline", this.displayTitle = "", this.featurePlacement = new w("#right-sidebar-content", "end")
            }
        },
        I = class extends S {
            constructor() {
                super(), this.featureId = "properties", this.displayTitle = "", this.featurePlacement = new w(".header", "start")
            }
        },
        z = class extends y {
            constructor() {
                super(), this.siteUrl = "", this.authorName = "", this.featureId = "rss"
            }
        },
        R = class extends S {
            constructor() {
                super(), this.featureId = "search", this.displayTitle = "", this.featurePlacement = new w("#left-sidebar .topbar-content", "start")
            }
        },
        N = class extends y {
            constructor() {
                super(), this.allowResizing = !0, this.allowCollapsing = !0, this.rightDefaultWidth = "20em", this.leftDefaultWidth = "20em", this.featureId = "sidebar"
            }
        },
        A = class extends S {
            constructor() {
                super(), this.showInlineTags = !0, this.showFrontmatterTags = !0, this.featureId = "tags", this.displayTitle = "", this.featurePlacement = new w(".header .data-bar", "end")
            }
        },
        D = class extends S {
            constructor() {
                super(), this.featureId = "theme-toggle", this.displayTitle = "", this.featurePlacement = new w("#right-sidebar .topbar-content", "start")
            }
        },
        W = class {
            static fromJSON(t) {
                let e = Object.assign(new W, JSON.parse(t));
                return e.backlinks = Object.assign(new L, e.backlinks), e.tags = Object.assign(new A, e.tags), e.alias = Object.assign(new k, e.alias), e.properties = Object.assign(new I, e.properties), e.fileNavigation = Object.assign(new T, e.fileNavigation), e.search = Object.assign(new R, e.search), e.outline = Object.assign(new M, e.outline), e.themeToggle = Object.assign(new D, e.themeToggle), e.graphView = Object.assign(new O, e.graphView), e.sidebar = Object.assign(new N, e.sidebar), e.customHead = Object.assign(new P, e.customHead), e.document = Object.assign(new C, e.document), e.rss = Object.assign(new z, e.rss), e.linkPreview = Object.assign(new F, e.linkPreview), e
            }
        },
        H = class {
            constructor() {
                this.ignoreMetadata = !1, this.webpages = {}, this.fileInfo = {}, this.sourceToTarget = {}, this.attachments = [], this.shownInTree = [], this.allFiles = [], this.siteName = "", this.vaultName = "", this.createdTime = 0, this.modifiedTime = 0, this.pluginVersion = "", this.exportRoot = "", this.baseURL = "", this.themeName = "", this.bodyClasses = "", this.hasFavicon = !1, this.featureOptions = new W
            }
            static fromJSON(t) {
                let e = Object.assign(new H, JSON.parse(t));
                return e.featureOptions = W.fromJSON(JSON.stringify(e.featureOptions)), e
            }
        },
        q = class {
            constructor(t, e = !0) {
        ...
        V = class {
            constructor(t) {
                this._children = [], this._isCollapsed = !1, this._content = [], this._divParent = t.parentElement, this._headerElement = t, this._collapseIndicatorElement = this._headerElement.querySelector(".heading-collapse-indicator"), this._id = t.id, this._level = parseInt(t.tagName.replace("H", "")), V.headerMap.set(t, this), this._collapseIndicatorElement && this._collapseIndicatorElement.addEventListener("click", (() => {
                    this.toggleCollapse()
                }))
            }
            get id() {
            ...
            set text(t) {
                this._headerElement.textContent = t
            }
            get level() {
                return this._level
            }
            ...
            scrollTo(t = {
                ...
                this._headerElement.scrollIntoView(t)
            }
            find(t) {
            ...
            getFlatChildren() {
                let t = [this];
                for (const e of this._children) t = t.concat(e.getFlatChildren());
                return t
            }
            toggleCollapse() {
                this._isCollapsed = !this._isCollapsed, this._collapseIndicatorElement?.classList.toggle("is-collapsed", this._isCollapsed), this._headerElement.classList.toggle("is-collapsed", this._isCollapsed), this.updateVisibility(this._isCollapsed)
            }
            updateVisibility(t) {
                this._collapseIndicatorElement?.classList.toggle("is-collapsed", t), this._headerElement.classList.toggle("is-collapsed", t);
                for (const e of this._content) e.style.display = t ? "none" : "";
                for (const e of this._children) e.headerElement.style.display = t ? "none" : "", t ? e.updateVisibility(!0) : e.updateVisibility(e._isCollapsed)
            }
            getHeaderWithContentRecursive() {
                let t = [];
                t.push(this._divParent);
                for (const e of this._content) t.push(e);
                for (const e of this._children) t = t.concat(e.getHeaderWithContentRecursive());
                return t
            }
            static createHeaderTree(t) {
                const e = Array.from(t.querySelectorAll("h1, h2, h3, h4, h5, h6")).map((t => new V(t))),
                    i = [],
                    s = [];
                for (let t = 0; t < e.length; t++) {
                    const n = e[t];
                    for (; s.length > 0 && s[s.length - 1].level >= n.level;) s.pop();
                    s.length > 0 ? s[s.length - 1].children.push(n) : i.push(n), s.push(n);
                    let o = n.headerElement.nextElementSibling;
                    for (; o && !(o instanceof HTMLHeadingElement);) o instanceof HTMLElement && n._content.push(o), o = o.nextElementSibling;
                    for (o = n.headerElement.parentElement?.nextElementSibling ?? null; o && !o.querySelector("h1, h2, h3, h4, h5, h6");) o instanceof HTMLElement && !o.classList.contains("footer") && n._content.push(o), o = o.nextElementSibling
                }
                return i
            }
        },
        B = V;
    B.headerMap = new WeakMap;
    var j = class {
            constructor(t, e, i) {
                this.isPinned = !1, this.resizeObserver = null, this.hoverTimeout = null, this.showTimeout = null, this.link = t, this.target = e, this.onRemove = i, this.createPreviewElements(), this.setupEventListeners(), this.positionPreview(), this.setupOutsideClickListener()
            }
            static savePinnedPreviews() {
                const t = j.pinnedPreviews.map((t => ({
                    target: t.target,
                    top: t.filePreviewPopover.style.top,
                    left: t.filePreviewPopover.style.left,
                    width: t.filePreviewPopover.style.width,
                    height: t.filePreviewPopover.style.height,
                    zIndex: t.filePreviewPopover.style.zIndex
                })));
                localStorage.setItem("pinnedPreviews", JSON.stringify(t))
            }
            static loadPinnedPreviews() {
                JSON.parse(localStorage.getItem("pinnedPreviews") ?? "[]").forEach((async t => {
                    const e = new j(null, t.target, (() => {}));
                    e.setPinned(!0), e.filePreviewPopover.style.top = t.top, e.filePreviewPopover.style.left = t.left, e.filePreviewPopover.style.width = t.width, e.filePreviewPopover.style.height = t.height, e.filePreviewPopover.style.zIndex = t.zIndex || j.baseZIndex.toString(), e.show()
                }))
            }
            static create(t, e, i, s = !0) {
                const n = new j(null, t, (() => {}));
                n.setPinned(s), n.filePreviewPopover.style.top = i + "px", n.filePreviewPopover.style.left = e + "px", n.show()
            }
            static initializeLink(t, e) {
                let i = null;
                t.addEventListener("pointerenter", (function() {
                    ...
                    i && (i.isPinned || i.startRemoveTimeout(), i.clearShowTimeout())
                })), t.addEventListener("click", (function(t) {
                    i && (i.isPinned || i.startRemoveTimeout(), i.clearShowTimeout())
                }))
            }
            createPreviewElements() {
                this.filePreviewPopover = document.createElement("div"), this.filePreviewPopover.className = "file-preview popover hover-popover hide", document.body.appendChild(this.filePreviewPopover), this.markdownEmbed = document.createElement("div"), this.markdownEmbed.className = "markdown-embed", this.filePreviewPopover.appendChild(this.markdownEmbed), this.markdownEmbedContent = document.createElement("div"), this.markdownEmbedContent.className = "markdown-embed-content", this.markdownEmbed.appendChild(this.markdownEmbedContent), this.actionContainer = document.createElement("div"), this.actionContainer.className = "preview-action-container", this.filePreviewPopover.appendChild(this.actionContainer), this.dragHandle = document.createElement("div"), this.dragHandle.className = "drag-handle clickable-icon popover-action", this.actionContainer.appendChild(this.dragHandle), this.pinButton = document.createElement("button"), this.pinButton.className = "pin-button clickable-icon popover-action", this.actionContainer.appendChild(this.pinButton), this.goToButton = document.createElement("button"), this.goToButton.className = "go-to-button clickable-icon popover-action", this.actionContainer.appendChild(this.goToButton), this.filePreviewPopover.style.zIndex = j.baseZIndex.toString(), this.bringToFront()
            }
            setPinned(t) {
                this.isPinned = t, this.pinButton.classList.toggle("pinned", this.isPinned), this.filePreviewPopover.classList.toggle("pinned", this.isPinned), this.isPinned ? j.pinnedPreviews.push(this) : j.pinnedPreviews = j.pinnedPreviews.filter((t => t !== this))
            }
            setupEventListeners() {
                this.pinButton.addEventListener("click", (() => {
                    this.setPinned(!this.isPinned), j.savePinnedPreviews()
                })), this.goToButton.addEventListener("click", (() => {
                    ObsidianSite.loadURL(this.target)
                })), this.setupDragHandleListeners(), this.filePreviewPopover.addEventListener("pointerenter", (() => {
                    this.clearRemoveTimeout()
                })), this.filePreviewPopover.addEventListener("pointerleave", (() => {
                    this.isPinned || this.startRemoveTimeout()
                })), this.setupResizeObserver()
            }
            updateMaxSize() {
                const t = window.innerWidth,
                    e = window.innerHeight,
                    i = this.filePreviewPopover.getBoundingClientRect(),
                    s = t - i.left - 10,
                    n = e - i.top - 10;
                this.filePreviewPopover.style.maxWidth = `${s}px`, this.filePreviewPopover.style.maxHeight = `${n}px`;
                const o = Math.max(10, i.left),
                    a = Math.max(10, i.top);
                o !== i.left && (this.filePreviewPopover.style.left = `${o}px`), a !== i.top && (this.filePreviewPopover.style.top = `${a}px`), j.savePinnedPreviews()
            }
            setupResizeObserver() {
                this.updateMaxSize(), this.resizeObserver = new ResizeObserver((() => {
                    this.updateMaxSize()
                })), this.resizeObserver.observe(this.filePreviewPopover), window.addEventListener("resize", this.updateMaxSize)
            }
            dragPreviewCallback(t) {
                t.stopPropagation(), this.bringToFront();
                const e = t.clientX - this.filePreviewPopover.getBoundingClientRect().left,
                    i = t.clientY - this.filePreviewPopover.getBoundingClientRect().top,
                    s = t => {
                        let s = t.clientX - e,
                            n = t.clientY - i;
                        const o = window.innerWidth,
                            a = window.innerHeight,
                            r = this.filePreviewPopover.getBoundingClientRect();
                        s = Math.max(0, Math.min(s, o - r.width)), n = Math.max(0, Math.min(n, a - r.height)), this.filePreviewPopover.style.left = s + "px", this.filePreviewPopover.style.top = n + "px", this.updateMaxSize()
                    },
                    n = () => {
                        this.isPinned && j.savePinnedPreviews(), document.removeEventListener("pointermove", s), document.removeEventListener("pointerup", n)
                    };
                document.addEventListener("pointermove", s), document.addEventListener("pointerup", n)
            }
            setupDragHandleListeners() {
                this.dragHandle.addEventListener("pointerdown", this.dragPreviewCallback.bind(this)), this.actionContainer.addEventListener("pointerdown", this.dragPreviewCallback.bind(this))
            }
            positionPreview() {
                if (!this.link) return;
                const t = this.link.getBoundingClientRect(),
                    e = this.filePreviewPopover.getBoundingClientRect(),
                    i = window.innerWidth,
                    s = window.innerHeight;
                this.filePreviewPopover.style.top = "", this.filePreviewPopover.style.left = "";
                const n = 10;
                let o, a;
                o = s - t.bottom >= e.height + n ? t.bottom + n : Math.max(n, t.top - e.height - n), a = t.left, a + e.width > i - n && (a = Math.max(n, t.right - e.width)), o = Math.min(Math.max(n, o), s - e.height - n), a = Math.min(Math.max(n, a), i - e.width - n), this.filePreviewPopover.style.top = `${o}px`, this.filePreviewPopover.style.left = `${a}px`
            }
            setupOutsideClickListener() {
                this.outsideClickListener = t => {
                    this.isPinned || this.filePreviewPopover.contains(t.target) || this.link?.contains(t.target) || this.remove()
                }, document.addEventListener("pointerdown", this.outsideClickListener)
            }
            startShowTimeout() {
                this.clearShowTimeout(), this.showTimeout = window.setTimeout((() => this.show()), 350)
            }
            clearShowTimeout() {
                null !== this.showTimeout && (clearTimeout(this.showTimeout), this.showTimeout = null)
            }
            async show() {
                this.filePreviewDocument = new J(this.target), await ((await this.filePreviewDocument.load(null, this.markdownEmbedContent, !0, !0))?.show()), this.positionPreview(), this.filePreviewPopover.classList.remove("hide")
            }
            bringToFront() {
                let t = Math.max(j.baseZIndex, ...j.pinnedPreviews.map((t => parseInt(t.filePreviewPopover.style.zIndex) || j.baseZIndex)));
                t >= j.maxZIndex && (j.pinnedPreviews.forEach(((t, e) => {
                    t.filePreviewPopover.style.zIndex = (j.baseZIndex + e).toString()
                })), t = j.baseZIndex + j.pinnedPreviews.length - 1), this.filePreviewPopover.style.zIndex = (t + 1).toString()
            }
            startRemoveTimeout() {
                this.clearRemoveTimeout(), this.hoverTimeout = window.setTimeout((() => this.remove()), 300)
            }
            clearRemoveTimeout() {
                null !== this.hoverTimeout && (clearTimeout(this.hoverTimeout), this.hoverTimeout = null)
            }
            remove() {
                this.clearRemoveTimeout(), this.clearShowTimeout(), this.filePreviewPopover && this.filePreviewPopover.parentNode && this.filePreviewPopover.parentNode.removeChild(this.filePreviewPopover), this.resizeObserver && this.resizeObserver.disconnect(), window.removeEventListener("resize", this.updateMaxSize), document.removeEventListener("pointerdown", this.outsideClickListener), this.onRemove()
            }
        },
        U = j;
    U.baseZIndex = 100, U.maxZIndex = 1e3, U.pinnedPreviews = [];
    var $ = class {
            static initializeLinks(t) {
                console.log("Initializing links on element", t), t?.querySelectorAll(".internal-link, a.tag, a.tree-item-self, a.footnote-link").forEach((function(t) {
                    ...
                    "null" != e ? (t.addEventListener("click", (function(i) {
                        if (i.preventDefault(), i.stopPropagation(), ObsidianSite.loadURL(e), "phone" === ObsidianSite.deviceSize) {
                            const e = t.closest("#left-sidebar"),
                                i = t.closest("#right-sidebar");
                            e && !1 === ObsidianSite.leftSidebar?.collapsed ? ObsidianSite.leftSidebar.collapsed = !0 : i && !1 === ObsidianSite.rightSidebar?.collapsed && (ObsidianSite.rightSidebar.collapsed = !0)
                        }
                    })), !e || e.startsWith("http") || ObsidianSite.documentExists(e) ? t.classList.contains("internal-link") && !ObsidianSite.metadata?.ignoreMetadata && ObsidianSite.metadata?.featureOptions?.linkPreview?.enabled && U.initializeLink(t, e) : t.classList.add("is-unresolved")) : console.log("No target found for link")
                }))
            }
            static getPathnameFromURL(t) {
                return "" == t || "/" == t || "\\" == t ? "index.html" : t?.startsWith("#") || t?.startsWith("?") ? (ObsidianSite.document?.pathname?.split("#")[0]?.split("?")[0] ?? "") + (t ?? "") : t?.split("?")[0]?.split("#")[0]?.trim() ?? ""
            }
            static getHashFromURL(t) {
                return (t.split("#")[1] ?? "").split("?")[0]?.trim() ?? ""
            }
            static getQueryFromURL(t) {
                return t.split("?")[1]?.trim() ?? ""
            }
            static getFileDataIdFromURL(t) {
                for ((t = this.getPathnameFromURL(t)).startsWith("./") && (t = t.substring(2)); t.startsWith("../");) t = t.substring(3);
        ...
        G = class {
            constructor(t, e) {
                ...
                if (i && (this.child = new Y(i, this), this.collapseEl)) {
                    this.collapsible = !0;
                    const t = this;
        ...
        Y = class {
            constructor(t, e) {
                ...
                Array.from(this.listEl.children).filter((t => "LI" == t.tagName)).forEach((t => {
                    this.children.push(new G(t, this))
                }))
            }
            get linearList() {
                let t = [];
        ...
        J = class {
            ...
            getFlatHeaders() {
                return this.headers.flatMap((t => t.getFlatChildren()))
            }
            scrollToHeader(t) {
                console.log("Scrolling to header", t);
                const e = this.findHeader((e => e.id == t));
                e && e.scrollTo()
            }
            findElements() {
                this.containerEl || (this.containerEl = ObsidianSite.centerContentEl), this.sizerEl = "markdown" == this.documentType ? this.containerEl.querySelector(".markdown-preview-sizer") : void 0, this.documentEl = this.containerEl.querySelector(".obsidian-document"), this.headerEl = this.containerEl.querySelector(".header"), this.footerEl = this.containerEl.querySelector(".footer")
            }
            async load(t = null, e = ObsidianSite.centerContentEl, i = !1, s = !1) {
                if (this.parent = t, this.isPreview = i, !this.pathname || !this.exists) return this;
                ObsidianSite.document;
                await ObsidianSite.showLoading(!0, e), this.containerEl = e;
                const n = await ObsidianSite.fetch(this.pathname);
                if (!n?.ok) return new K("This document could not be loaded."), void console.error("Failed to load document", this.pathname);
                {
                    const t = await n.text();
                    this.sourceHtml = (new DOMParser).parseFromString(t, "text/html");
                    let i = this.sourceHtml.querySelector(".obsidian-document");
                    if (i) {
                        i = document.adoptNode(i);
                        const t = e.querySelector(".obsidian-document");
                        t ? (t.before(i), t.remove()) : e.appendChild(i)
                    }
                    if (await this.loadChildDocuments(), await this.postLoadInit(), this.sizerEl && s && this.hash && "" != this.hash) {
                        var o = this.headers.find((t => t.findByID(this.hash)))?.findByID(this.hash);
                        o && (this.sizerEl.innerHTML = o.getHeaderWithContentRecursive().map((t => t.outerHTML)).join(""))
                    }
                    this.initialized = !1
                }
                return this
            ...
            async show() {
                await ObsidianSite.showLoading(!1, this.containerEl)
            }
            async postLoadInit() {
                return this.findElements(), this.postProcess(), (this.isMainDocument || this.isPreview) && (this.processHeaders(), this.processCallouts(), this.processLists()), "canvas" == this.documentType && (this.canvas = new v(this)), (this.isMainDocument || this.isPreview) && $.initializeLinks(this.documentEl ?? this.containerEl), this
            }
            processHeaders() {
                this.headers = B.createHeaderTree(this.documentEl)
            }
            processCallouts() {
                const t = Array.from(this.documentEl.querySelectorAll(".callout"));
                this.callouts = [];
                for (const e of t) this.callouts.push(new q(e))
            }
            processLists() {
                const t = Array.from(this.documentEl.querySelectorAll(":is(ul, ol):not(:is(ul, ol) :is(ul, ol))"));
                this.lists = [];
                for (const e of t) this.lists.push(new Y(e, void 0))
            }
            postProcess() {
                this.documentEl?.querySelectorAll(".kanban-plugin__item.is-complete input[type='checkbox']").forEach((t => t.checked = !0)), ObsidianSite.metadata.ignoreMetadata || (this.documentEl?.classList.toggle("allow-fold-headings", ObsidianSite.metadata.featureOptions.document.allowFoldingHeadings), this.documentEl?.classList.toggle("allow-fold-lists", ObsidianSite.metadata.featureOptions.document.allowFoldingLists))
            }
            async loadChildDocuments() {
                ...
                for (const t of i) {
                    ...
                    if (!e) continue;
                    const i = new J(e).load(this, t.parentElement);
                    s.push(i), console.log("Loading child", e), t.remove()
                }
                const n = await Promise.all(s);
                console.log("Loaded child documents", n), this.children.push(...n.filter((t => null != t)))
            }
            async loadChild(t, e) {
                let i = new J(t),
                    s = await i.load(this, e);
                return s && this.children.push(s), s
            }
            async unloadChild(t) {
                this.children = this.children.filter((e => e != t)), t.documentEl?.remove()
            }
            getMinReadableWidth() {
                return 30 * parseFloat(getComputedStyle(this.sizerEl ?? this.documentEl).fontSize)
            }
        };
    ...
    var Q = "KEYS",
        ...
        et = class {
            constructor(t, e) {
                const i = t._tree,
                    s = Array.from(i.keys());
                this.set = t, this._type = e, this._path = s.length > 0 ? [{
                    node: i,
                    keys: s
                }] : []
            }
        ...
        st = (t, e, i, s, n, o, a, r) => {
            const h = o * a;
            t: for (const l of t.keys())
                if (l === tt) {
                    const e = n[h - 1];
                    e <= i && s.set(r, [t.get(l), e])
                } else {
                    let h = o;
                    for (let t = 0; t < l.length; ++t, ++h) {
                        const s = l[t],
                            o = a * h,
                            r = o - a;
                        let c = n[o];
                        const d = Math.max(0, h - i - 1),
                            u = Math.min(a - 1, h + i);
                        for (let t = d; t < u; ++t) {
                            const i = s !== e[t],
                                a = n[r + t] + +i,
                                h = n[r + t + 1] + 1,
                                l = n[o + t] + 1,
                                d = n[o + t + 1] = Math.min(a, h, l);
                            d < c && (c = d)
                        }
                        if (c > i) continue t
                    }
                    st(t.get(l), e, i, s, n, h, a, r + l)
                }
        },
        nt = class {
            ...
            atPrefix(t) {
                ...
                const [e, i] = ot(this._tree, t.slice(this._prefix.length));
                if (void 0 === e) {
                    const [e, s] = dt(i);
                    for (const i of e.keys())
                        if (i !== tt && i.startsWith(s)) {
                            const n = new Map;
                            return n.set(i.slice(s.length), e.get(i)), new nt(n, t)
                        }
                }
                return new nt(e, t)
            }
            ...
            delete(t) {
                return this._size = void 0, ht(this._tree, t)
            }
            entries() {
                return new et(this, "ENTRIES")
            }
            forEach(t) {
                for (const [e, i] of this) t(e, i, this)
            }
            fuzzyGet(t, e) {
                return ((t, e, i) => {
                    const s = new Map;
                    ...
                    const n = e.length + 1,
                        o = n + i,
                        a = new Uint8Array(o * n).fill(i + 1);
                    for (let t = 0; t < n; ++t) a[t] = t;
                    for (let t = 1; t < o; ++t) a[t * n] = t;
                    return st(t, e, i, s, a, 1, n, ""), s
                })(this._tree, t, e)
            }
            get(t) {
                const e = at(this._tree, t);
                return void 0 !== e ? e.get(tt) : void 0
            }
            has(t) {
                const e = at(this._tree, t);
                return void 0 !== e && e.has(tt)
            }
            keys() {
                return new et(this, Q)
            }
            set(t, e) {
                if ("string" != typeof t) throw new Error("key must be a string");
                this._size = void 0;
                return rt(this._tree, t).set(tt, e), this
            }
            get size() {
            ...
            update(t, e) {
                if ("string" != typeof t) throw new Error("key must be a string");
                this._size = void 0;
                const i = rt(this._tree, t);
                return i.set(tt, e(i.get(tt))), this
            }
            fetch(t, e) {
                if ("string" != typeof t) throw new Error("key must be a string");
                this._size = void 0;
                const i = rt(this._tree, t);
                let s = i.get(tt);
                return void 0 === s && i.set(tt, s = e()), s
            }
            values() {
                return new et(this, Z)
            } [Symbol.iterator]() {
                return this.entries()
            }
            static from(t) {
            ...
            static fromObject(t) {
                return nt.from(Object.entries(t))
            }
        },
        ot = (t, e, i = []) => {
            if (0 === e.length || null == t) return [t, i];
            for (const s of t.keys())
                if (s !== tt && e.startsWith(s)) return i.push([t, s]), ot(t.get(s), e.slice(s.length), i);
            return i.push([t, e]), ot(void 0, "", i)
        },
        at = (t, e) => {
            if (0 === e.length || null == t) return t;
            for (const i of t.keys())
                if (i !== tt && e.startsWith(i)) return at(t.get(i), e.slice(i.length))
        },
        rt = (t, e) => {
            const i = e.length;
            t: for (let s = 0; t && s < i;) {
                for (const n of t.keys())
                    if (n !== tt && e[s] === n[0]) {
                        ...
                        if (a === n.length) t = r;
                            ...
                            const i = new Map;
                            i.set(n.slice(a), r), t.set(e.slice(s, s + a), i), t.delete(n), t = i
                        }
                        s += a;
                        continue t
                    } const n = new Map;
                return t.set(e.slice(s), n), n
            }
            return t
        },
        ht = (t, e) => {
            const [i, s] = ot(t, e);
            if (void 0 !== i)
                if (i.delete(tt), 0 === i.size) lt(s);
                else if (1 === i.size) {
                const [t, e] = i.entries().next().value;
                ct(s, t, e)
            }
        },
        lt = t => {
            ...
            const [e, i] = dt(t);
            if (e.delete(i), 0 === e.size) lt(t.slice(0, -1));
            else if (1 === e.size) {
                const [i, s] = e.entries().next().value;
                i !== tt && ct(t.slice(0, -1), i, s)
            }
        },
        ct = (t, e, i) => {
            if (0 === t.length) return;
            const [s, n] = dt(t);
            s.set(n + e, i), s.delete(n)
        },
        dt = t => t[t.length - 1],
        ut = "or",
        pt = class {
            constructor(t) {
                ...
                const e = null == t.autoVacuum || !0 === t.autoVacuum ? Ct : t.autoVacuum;
                this._options = Object.assign(Object.assign(Object.assign({}, _t), t), {
                    autoVacuum: e,
                    searchOptions: Object.assign(Object.assign({}, kt), t.searchOptions || {}),
                    autoSuggestOptions: Object.assign(Object.assign({}, Lt), t.autoSuggestOptions || {})
            ...
            add(t) {
                const {
                    ...
                    fields: n,
                    idField: o
                } = this._options, a = e(t, o);
                if (null == a) throw new Error(`MiniSearch: document does not have ID field "${o}"`);
                if (this._idToShortId.has(a)) throw new Error(`MiniSearch: duplicate ID ${a}`);
                const r = this.addDocumentId(a);
                this.saveStoredFields(r, t);
                for (const o of n) {
                    const n = e(t, o);
                    if (null == n) continue;
                    const a = i(n.toString(), o),
                        h = this._fieldIds[o],
                        l = new Set(a).size;
                    this.addFieldLength(r, h, this._documentCount - 1, l);
                    for (const t of a) {
                        const e = s(t, o);
                        if (Array.isArray(e))
                            for (const t of e) this.addTerm(h, r, t);
                        else e && this.addTerm(h, r, e)
                    }
                }
            }
            addAll(t) {
            ...
            addAllAsync(t, e = {}) {
                const {
                    ...
                    chunk: t,
                    promise: e
                }, s, n) => (t.push(s), (n + 1) % i == 0 ? {
                    chunk: [],
                    promise: e.then((() => new Promise((t => setTimeout(t, 0))))).then((() => this.addAll(t)))
                } : {
                    chunk: t,
                    promise: e
                })), s);
            ...
            remove(t) {
                const {
                    ...
                    fields: n,
                    idField: o
                } = this._options, a = s(t, o);
                if (null == a) throw new Error(`MiniSearch: document does not have ID field "${o}"`);
                const r = this._idToShortId.get(a);
                if (null == r) throw new Error(`MiniSearch: cannot remove document with ID ${a}: it is not in the index`);
                for (const o of n) {
                    const n = s(t, o);
                    if (null == n) continue;
                    const a = e(n.toString(), o),
                        h = this._fieldIds[o],
                        l = new Set(a).size;
                    this.removeFieldLength(r, h, this._documentCount, l);
                    for (const t of a) {
                        const e = i(t, o);
                        if (Array.isArray(e))
                            for (const t of e) this.removeTerm(h, r, t);
                        else e && this.removeTerm(h, r, e)
                    }
                }
                this._storedFields.delete(r), this._documentIds.delete(r), this._idToShortId.delete(a), this._fieldLength.delete(r), this._documentCount -= 1
            }
            removeAll(t) {
                if (t)
                    ...
                    this._index = new nt, this._documentCount = 0, this._documentIds = new Map, this._idToShortId = new Map, this._fieldLength = new Map, this._avgFieldLength = [], this._storedFields = new Map, this._nextId = 0
                }
            }
            discard(t) {
                const e = this._idToShortId.get(t);
                if (null == e) throw new Error(`MiniSearch: cannot discard document with ID ${t}: it is not in the index`);
                this._idToShortId.delete(t), this._documentIds.delete(e), this._storedFields.delete(e), (this._fieldLength.get(e) || []).forEach(((t, i) => {
                    this.removeFieldLength(e, i, this._documentCount, t)
            ...
            replace(t) {
                const {
                    idField: e,
                    extractField: i
                } = this._options, s = i(t, e);
                this.discard(s), this.add(t)
            }
            vacuum(t = {}) {
                return this.conditionalVacuum(t)
            }
            conditionalVacuum(t, e) {
                return this._currentVacuum ? (this._enqueuedVacuumConditions = this._enqueuedVacuumConditions && e, null != this._enqueuedVacuum || (this._enqueuedVacuum = this._currentVacuum.then((() => {
                    const e = this._enqueuedVacuumConditions;
                    return this._enqueuedVacuumConditions = Pt, this.performVacuuming(t, e)
            ...
            performVacuuming(t, e) {
                return X(this, void 0, void 0, (function*() {
                    const i = this._dirtCount;
                    if (this.vacuumConditionsMet(e)) {
                        const e = t.batchSize || xt.batchSize,
                            s = t.batchWait || xt.batchWait;
                        let n = 1;
                        for (const [t, i] of this._index) {
                            for (const [t, e] of i)
                                for (const [s] of e) this._documentIds.has(s) || (e.size <= 1 ? i.delete(t) : e.delete(s));
                            0 === this._index.get(t).size && this._index.delete(t), n % e == 0 && (yield new Promise((t => setTimeout(t, s)))), n += 1
                        }
                        this._dirtCount -= i
                    }
            ...
            vacuumConditionsMet(t) {
                ...
                return e = e || Ct.minDirtCount, i = i || Ct.minDirtFactor, this.dirtCount >= e && this.dirtFactor >= i
            }
            get isVacuuming() {
            ...
            search(t, e = {}) {
                ...
                for (const [t, {
                    ...
                    Object.assign(r, this._storedFields.get(t)), (null == e.filter || e.filter(r)) && s.push(r)
                }
                return t === pt.wildcard && null == e.boostDocument && null == this._options.searchOptions.boostDocument || s.sort(Ft), s
            }
            autoSuggest(t, e = {}) {
                ...
                for (const {
                    ...
                    const t = n.join(" "),
                        e = i.get(t);
                    null != e ? (e.score += s, e.count += 1) : i.set(t, {
                        score: s,
                        terms: n,
                        count: 1
                    })
            ...
            static getDefault(t) {
                if (_t.hasOwnProperty(t)) return wt(_t, t);
            ...
            static loadJS(t, e) {
                ...
                } = t, r = this.instantiateMiniSearch(t, e);
                r._documentIds = It(s), r._fieldLength = It(n), r._storedFields = It(o);
                for (const [t, e] of r._documentIds) r._idToShortId.set(e, t);
                for (const [t, e] of i) {
                    const i = new Map;
                    for (const t of Object.keys(e)) {
                        let s = e[t];
                        1 === a && (s = s.ds), i.set(parseInt(t, 10), It(s))
                    }
                    r._index.set(t, i)
                }
                return r
            ...
            static loadJSAsync(t, e) {
                return X(this, void 0, void 0, (function*() {
                    ...
                    r._documentIds = yield zt(s), r._fieldLength = yield zt(n), r._storedFields = yield zt(o);
                    for (const [t, e] of r._documentIds) r._idToShortId.set(e, t);
                    let h = 0;
                    for (const [t, e] of i) {
                        const i = new Map;
                        for (const t of Object.keys(e)) {
                            let s = e[t];
                            1 === a && (s = s.ds), i.set(parseInt(t, 10), yield zt(s))
                        }++h % 1e3 == 0 && (yield Rt(0)), r._index.set(t, i)
                    }
                    return r
                }))
            }
            static instantiateMiniSearch(t, e) {
                ...
                if (1 !== r && 2 !== r) throw new Error("MiniSearch: cannot deserialize an index created with an incompatible version");
                const h = new pt(e);
                return h._documentCount = i, h._nextId = s, h._idToShortId = new Map, h._fieldIds = n, h._avgFieldLength = o, h._dirtCount = a || 0, h._index = new nt, h
            }
            executeQuery(t, e = {}) {
                if (t === pt.wildcard) return this.executeWildcardQuery(e);
                if ("string" != typeof t) {
                    const i = Object.assign(Object.assign(Object.assign({}, e), t), {
                            queries: void 0
                        }),
                        s = t.queries.map((t => this.executeQuery(t, i)));
                    return this.combineResults(s, i.combineWith)
                }
                const {
                    tokenize: i,
                    processTerm: s,
                    searchOptions: n
                } = this._options, o = Object.assign(Object.assign({
                    tokenize: i,
                    processTerm: s
                }, n), e), {
                    tokenize: a,
                    processTerm: r
                } = o, h = a(t).flatMap((t => r(t))).filter((t => !!t)).map(St(o)).map((t => this.executeQuerySpec(t, o)));
                return this.combineResults(h, o.combineWith)
            }
            executeQuerySpec(t, e) {
                const i = Object.assign(Object.assign({}, this._options.searchOptions), e),
                    s = (i.fields || this._options.fields).reduce(((t, e) => Object.assign(Object.assign({}, t), {
                        [e]: wt(i.boost, e) || 1
                    })), {}),
                    {
                        boostDocument: n,
                    ...
                    } = i,
                    {
                        fuzzy: h,
                        prefix: l
                    } = Object.assign(Object.assign({}, kt.weights), o),
                    c = this._index.get(t.term),
                    d = this.termResults(t.term, t.term, 1, t.termBoost, c, s, n, r);
                let u, p;
                if (t.prefix && (u = this._index.atPrefix(t.term)), t.fuzzy) {
                    const e = !0 === t.fuzzy ? .2 : t.fuzzy,
                        i = e < 1 ? Math.min(a, Math.round(t.term.length * e)) : e;
                    i && (p = this._index.fuzzyGet(t.term, i))
                }
                if (u)
                    for (const [e, i] of u) {
                        ...
                        if (!o) continue;
                        null == p || p.delete(e);
                        const a = l * e.length / (e.length + .3 * o);
                        this.termResults(t.term, e, a, t.termBoost, i, s, n, r, d)
                    }
                if (p)
                    for (const e of p.keys()) {
                        const [i, o] = p.get(e);
                        if (!o) continue;
                        const a = h * e.length / (e.length + o);
                        this.termResults(t.term, e, a, t.termBoost, i, s, n, r, d)
                    }
                return d
            }
            executeWildcardQuery(t) {
                const e = new Map,
                    i = Object.assign(Object.assign({}, this._options.searchOptions), t);
                for (const [t, s] of this._documentIds) {
                    const n = i.boostDocument ? i.boostDocument(s, "", this._storedFields.get(t)) : 1;
                    e.set(t, {
                        score: n,
                        terms: [],
                        match: {}
            ...
            combineResults(t, e = ut) {
                if (0 === t.length) return new Map;
                const i = e.toLowerCase(),
                    s = yt[i];
                if (!s) throw new Error(`Invalid combination operator: ${e}`);
                return t.reduce(s) || new Map
            }
            toJSON() {
                const t = [];
                for (const [e, i] of this._index) {
                    const s = {};
                    for (const [t, e] of i) s[t] = Object.fromEntries(e);
                    t.push([e, s])
                }
                return {
            ...
            termResults(t, e, i, s, n, o, a, r, h = new Map) {
                if (null == n) return h;
                for (const l of Object.keys(o)) {
                    ...
                    if (null == u) continue;
                    let p = u.size;
                    const m = this._avgFieldLength[d];
                    for (const n of u.keys()) {
                        if (!this._documentIds.has(n)) {
                            this.removeTerm(d, n, e), p -= 1;
                            continue
                        }
                        const o = a ? a(this._documentIds.get(n), e, this._storedFields.get(n)) : 1;
                        if (!o) continue;
                        const g = u.get(n),
                            f = this._fieldLength.get(n)[d],
                            b = i * s * c * o * Et(g, p, this._documentCount, f, m, r),
                            v = h.get(n);
                        if (v) {
                            v.score += b, Tt(v.terms, t);
                            const i = wt(v.match, e);
                            i ? i.push(l) : v.match[e] = [l]
                        } else h.set(n, {
                            score: b,
                            terms: [t],
                            match: {
            ...
            addTerm(t, e, i) {
                const s = this._index.fetch(i, Mt);
                let n = s.get(t);
                if (null == n) n = new Map, n.set(e, 1), s.set(t, n);
                else {
                    const t = n.get(e);
                    n.set(e, (t || 0) + 1)
                }
            ...
            removeTerm(t, e, i) {
                if (!this._index.has(i)) return void this.warnDocumentChanged(e, t, i);
                const s = this._index.fetch(i, Mt),
                    n = s.get(t);
                null == n || null == n.get(e) ? this.warnDocumentChanged(e, t, i) : n.get(e) <= 1 ? n.size <= 1 ? s.delete(t) : n.delete(e) : n.set(e, n.get(e) - 1), 0 === this._index.get(i).size && this._index.delete(i)
            }
            warnDocumentChanged(t, e, i) {
                for (const s of Object.keys(this._fieldIds))
                    if (this._fieldIds[s] === e) return void this._options.logger("warn", `MiniSearch: document with ID ${this._documentIds.get(t)} has changed before removal: term "${i}" was not present in field "${s}". Removing a document after it has changed can corrupt the index!`, "version_conflict")
            }
            addDocumentId(t) {
            ...
            addFieldLength(t, e, i, s) {
                let n = this._fieldLength.get(t);
                null == n && this._fieldLength.set(t, n = []), n[e] = s;
                const o = (this._avgFieldLength[e] || 0) * i + s;
                this._avgFieldLength[e] = o / (i + 1)
            }
            removeFieldLength(t, e, i, s) {
                if (1 === i) return void(this._avgFieldLength[e] = 0);
                const n = this._avgFieldLength[e] * i - s;
                this._avgFieldLength[e] = n / (i - 1)
            }
    ...
    pt.wildcard = Symbol("*");
    var mt, gt, ft, bt, vt, wt = (t, e) => Object.prototype.hasOwnProperty.call(t, e) ? t[e] : void 0,
        yt = {
            [ut]: (t, e) => {
                for (const i of e.keys()) {
                    const s = t.get(i);
                    if (null == s) t.set(i, e.get(i));
                        ...
                        s.score = s.score + t, s.match = Object.assign(s.match, o), Ot(s.terms, n)
                    }
                }
                return t
            },
            and: (t, e) => {
                ...
                for (const s of e.keys()) {
                    ...
                    Ot(n.terms, a), i.set(s, {
                        score: n.score + o,
                        terms: n.terms,
                        match: Object.assign(n.match, r)
                    })
                }
                return i
            },
            and_not: (t, e) => {
                for (const i of e.keys()) t.delete(i);
                return t
            }
        },
        Et = (t, e, i, s, n, o) => {
            ...
            return Math.log(1 + (i - e + .5) / (e + .5)) * (h + t * (a + 1) / (t + a * (1 - r + r * s / n)))
        },
        St = t => (e, i, s) => ({
            term: e,
            fuzzy: "function" == typeof t.fuzzy ? t.fuzzy(e, i, s) : t.fuzzy || !1,
            prefix: "function" == typeof t.prefix ? t.prefix(e, i, s) : !0 === t.prefix,
            termBoost: "function" == typeof t.boostTerm ? t.boostTerm(e, i, s) : 1
        }),
        _t = {
            idField: "id",
            extractField: (t, e) => t[e],
            tokenize: t => t.split(Nt),
        ...
        Ct = Object.assign(Object.assign({}, xt), Pt),
        Tt = (t, e) => {
            t.includes(e) || t.push(e)
        },
        Ot = (t, e) => {
            for (const i of e) t.includes(i) || t.push(i)
        },
        Ft = ({
            score: t
        }, {
        ...
        It = t => {
            const e = new Map;
            for (const i of Object.keys(t)) e.set(parseInt(i, 10), t[i]);
            return e
        },
        zt = t => X(void 0, void 0, void 0, (function*() {
            const e = new Map;
            let i = 0;
            for (const s of Object.keys(t)) e.set(parseInt(s, 10), t[s]), ++i % 1e3 == 0 && (yield Rt(0));
            return e
        })),
        Rt = t => new Promise((e => setTimeout(e, t))),
        Nt = /[\n\r\p{Z}\p{P}]+/u,
        At = class {
            search(t, e = 63) {
                if (0 == t.length) return void this.clear();
                this.input.value = t, this.input.style.color = 63 != e ? "var(--text-accent)" : "";
                const i = [];
                1 & e && i.push("title"), 2 & e && i.push("aliases"), 4 & e && i.push("headers"), 8 & e && i.push("tags"), 16 & e && i.push("path"), 32 & e && i.push("content"), console.log(1 & e, 2 & e, 4 & e, 8 & e, 16 & e, 32 & e);
                ...
                console.log("Search results", s), s.length > 50 && s.splice(50);
                const n = [],
                    o = new Map;
                for (const e of s) {
                    if (e.score < .3 * s[0].score && n.length > 4 || e.score < .1 * s[0].score) break;
                    if (n.push(e.path), t.length > 2) {
                        const i = [];
                        let s = !1;
                        for (const n in e.match) {
                            if (e.match[n].includes("headers"))
                                for (const o of e.headers)
                                    if (o.toLowerCase().includes(n.toLowerCase()) && (i.includes(o) || i.push(o), t.toLowerCase() != n.toLowerCase())) {
                                        s = !0;
                                        break
                                    } if (s) break
                        }
                ...
                if (ObsidianSite.fileTree?.filter(n), ObsidianSite.fileTree?.setSubHeadings(o), ObsidianSite.fileTree?.sort(((t, e) => t && e ? n.findIndex((e => t.path == e)) - n.findIndex((t => e.path == t)) : 0)), !ObsidianSite.fileTree) {
                    ...
                    })), this.dedicatedSearchResultsList.replaceChildren(e), this.container.after(this.dedicatedSearchResultsList), $.initializeLinks(this.dedicatedSearchResultsList)
                }
            }
            searchParseFilters(t) {
                t.startsWith("?") && (t = t.substring(1));
                let e = t.split(":")[0];
                t.includes(":") || (e = ""), "content" == e || "text" == e || "body" == e ? this.search(t, 32) : "title" == e || "name" == e ? this.search(t, 1) : "path" == e ? this.search(t, 16) : "header" == e || "headers" == e ? this.search(t, 4) : "tag" == e || "tags" == e || t.startsWith("#") ? this.search(t, 8) : "alias" == e || "aliases" == e ? this.search(t, 2) : this.search(t)
            }
            clear() {
                this.container?.classList.remove("has-content"), this.input.value = "", this.clearCurrentDocumentSearch(), ObsidianSite.fileTree?.unfilter(), ObsidianSite.fileTree?.removeSubHeadings(), ObsidianSite.fileTree?.unsort()
            }
            async init() {
                ...
                const t = await ObsidianSite.fetch(x.libFolderName + "/search-index.json");
                if (!t?.ok) return void console.error("Failed to fetch search index");
                const e = await t.json();
                try {
                    this.index = pt.loadJS(e, {
                ...
                return i?.addEventListener("click", (t => {
                    ...
                    0 != e.length ? this.searchParseFilters(e) : this.clear()
            ...
            async searchCurrentDocument(t) {
                ...
                (function(t) {
                    ...
                    return e
                })(ObsidianSite.document.sizerEl ?? ObsidianSite.document.documentEl).forEach((async e => {
                    const i = e.nodeValue,
        ...
        Dt = class {
            constructor(t) {
                ...
                })), this.clickOutsideCollapse = this.clickOutsideCollapse.bind(this), this.minResizeWidth = parseFloat(getComputedStyle(this.resizeHandleEl?.parentElement ?? this.resizeHandleEl).fontSize) * this.minWidthEm, this.collapseWidth = this.minResizeWidth / 4, this.setupSidebarResize()
            }
            get sidebarID() {
            ...
            set collapsed(t) {
                if (this._collapsed === t) return;
                this._collapsed = t;
                const e = "phone" === ObsidianSite.deviceSize,
                    i = "tablet" === ObsidianSite.deviceSize;
                t ? document.body.removeEventListener("click", this.clickOutsideCollapse) : (e && (this.isLeft ? ObsidianSite.rightSidebar && !ObsidianSite.rightSidebar.collapsed && (ObsidianSite.rightSidebar.collapsed = !0) : ObsidianSite.leftSidebar && !ObsidianSite.leftSidebar.collapsed && (ObsidianSite.leftSidebar.collapsed = !0)), (e || i) && (document.body.removeEventListener("click", this.clickOutsideCollapse), document.body.addEventListener("click", this.clickOutsideCollapse))), this.containerEl.classList.toggle("is-collapsed", t)
            }
            get floating() {
            ...
            clickOutsideCollapse(t) {
                if (t.target?.closest(`#${this.containerEl.id}`)) return;
                const e = "phone" === ObsidianSite.deviceSize,
                    i = "tablet" === ObsidianSite.deviceSize;
                (e || i) && (this.collapsed = !0)
            }
        },
        Wt = class {
            constructor(t, e, i = 0, s = 1) {
                this._path = "", this.collapseAnimationLength = 150, this._oldAnimationLength = this.collapseAnimationLength, this.root = this instanceof qt ? this : e?.root ?? (e instanceof qt ? e : void 0), this.parent = e, this.minCollapseDepth = s;
                let n = this instanceof qt;
                this.itemEl = t, this.selfEl = n ? t : t.querySelector(".tree-item-self"), this.collapseIconEl = n ? t : this.selfEl.querySelector(".collapse-icon"), this.innerEl = n ? t : this.selfEl.querySelector(".tree-item-inner"), this.childrenEl = n ? t : t.querySelector(".tree-item-children");
                const o = this.selfEl.getAttribute("href");
                o && (this.path = o), this.children = [];
                if (Array.from(this.childrenEl.children).filter((t => t.classList.contains("tree-item"))).forEach((t => {
                        this.children.push(new Wt(t, this, i + 1, this.minCollapseDepth))
                    })), this._isFolder = this.itemEl.classList.contains("nav-folder"), this._isLink = "A" == this.selfEl.tagName, this.depth = i, this._isCollapsible = this.itemEl.classList.contains("mod-collapsible") && this.depth >= this.minCollapseDepth, this._isCollapsible || (!this.collapseIconEl || this instanceof qt || (console.log(this), this.collapseIconEl.remove(), this.collapseIconEl = void 0), this.selfEl.classList.remove("mod-collapsible"), this.itemEl.classList.remove("mod-collapsible"), this.itemEl.classList.remove("is-collapsed")), this.collapsed = this.itemEl.classList.contains("is-collapsed"), this._isCollapsible) {
            ...
            set collapsed(t) {
                this.collapsable || (t = !1), this.collapsed != t && (!t && this.parent instanceof Wt && this.parent.collapsed && (this.parent.collapsed = !1), this._collapsed = t, this.itemEl.classList.toggle("is-collapsed", t), this.collapseIconEl?.classList.toggle("is-collapsed", t), t ? u(this.childrenEl, this.collapseAnimationLength) : p(this.childrenEl, this.collapseAnimationLength), this.parent?._checkAnyChildrenOpen())
            }
            ...
            setSubHeadings(t) {
                ...
                for (const [e, i] of t) {
                    ...
                    const t = this.findByPath(e);
                    if (!t) continue;
                    t.itemEl.classList.add("has-hints");
                    const s = document.createElement("div");
                    s.classList.add("tree-hint-container"), t.itemEl.appendChild(s), i.forEach((t => {
                        const i = document.createElement("a");
                        i.classList.add("tree-hint-label"), i.classList.add("internal-link"), i.textContent = t, i.href = e + "#" + t, s.appendChild(i)
                    })), $.initializeLinks(s)
                }
            }
            removeSubHeadings() {
                this.itemEl.classList.remove("has-hints"), this.itemEl.querySelectorAll(".tree-hint-container").forEach((t => {
                    t.remove()
                })), this.itemEl.querySelectorAll(".has-hints").forEach((t => {
                    t.classList.remove("has-hints")
                }))
            }
            sort(t) {
        ...
        Ht = class extends Wt {
            constructor(t, e = 1) {
                const i = t.classList.contains("tree-container") ? t : t.querySelector(".tree-container");
                if (null == i) throw new Error("Invalid tree container");
                super(i, void 0, 0, e), this.pathToItem = new Map, this.rootEl = i, this.childrenEl = this.rootEl, this.selfEl = this.rootEl, this.innerEl = this.rootEl, this.collapseAllEl = this.rootEl.querySelector(".tree-collapse-all");
                const s = this.collapseAllEl?.querySelector("svg");
                s && (s.innerHTML = "<path d></path><path d></path>", this.collapsePath1 = s.querySelector("path"), this.collapsePath2 = s.querySelector("path:last-child")), this.forAllChildren((t => {
                ...
                })), $.initializeLinks(this.rootEl), this.setCollapseIcon(!this.anyChildrenOpen)
            }
            _checkAnyChildrenOpen() {
            ...
            setCollapseIcon(t) {
                t ? (this.collapsePath1?.setAttribute("d", Ht.collapsePaths[0]), this.collapsePath2?.setAttribute("d", Ht.collapsePaths[1])) : (this.collapsePath1?.setAttribute("d", Ht.uncollapsePaths[0]), this.collapsePath2?.setAttribute("d", Ht.uncollapsePaths[1]))
            }
            revealPath(t) {
                const e = this.findByPath(t);
                e && (e.collapsed = !1)
        ...
        qt = Ht;
    qt.collapsePaths = ["m7 15 5 5 5-5", "m7 9 5-5 5 5"], qt.uncollapsePaths = ["m7 20 5-5 5 5", "m7 4 5 5 5-5"];
    var Vt, Bt, jt, Ut, $t, Gt, Yt, Kt, Jt = class {
        constructor() {
            this.nodeCount = 0, this.linkCount = 0, this.hoveredNode = -1, i(this, mt, 0), i(this, gt, 0), i(this, ft, 0), i(this, bt, 0), i(this, vt, 0), this.startPositions = new Float32Array(0), this.linkSources = new Int32Array(0), this.linkTargets = new Int32Array(0), this.radii = new Float32Array(0), this.maxRadius = 0, this.averageRadius = 0, this.minRadius = 0
        }
        init(t, i) {
        ...
        get positions() {
            return Module.HEAP32.buffer.slice(e(this, mt), e(this, mt) + e(this, gt))
        }
        get positionsF() {
        ...
        free() {
            Module._free(e(this, mt)), Module._free(e(this, ft)), Module._free(e(this, bt)), Module._free(e(this, vt)), Module._FreeMemory()
        }
        set batchFraction(t) {
    ...
    mt = new WeakMap, gt = new WeakMap, ft = new WeakMap, bt = new WeakMap, vt = new WeakMap;
    var Xt = class {
        constructor(t) {
            i(this, Vt), i(this, jt), i(this, $t), i(this, Yt), this.graph = t, this.canvas = document.querySelector("#graph-canvas"), this.canvasSidebar = this.canvas.closest(".sidebar"), console.log("Creating graph worker");
            try {
                this.view = this.canvas.transferControlToOffscreen()
            } catch (t) {
                console.log("Failed to transfer control to offscreen canvas")
            }
            var e = `${ObsidianSite.document.info.pathToRoot}/${x.libFolderName}/${x.scriptsFolderName}/graph-render-worker.js`;
            if ("file:" === window.location.protocol) {
                var s = ObsidianSite.getLocalDataFromId($.getFileDataIdFromURL(e));
                const t = Uint8Array.from(Array.from(s.data).map((t => t.charCodeAt(0))));
                this.worker = new Worker(URL.createObjectURL(new Blob([t], {
                    type: "application/javascript"
                })))
            } else this.worker = new Worker(new URL(e, window.location.href).pathname);
            this._cameraOffset = new c(0, 0), this._cameraScale = 1, this._hoveredNode = -1, this._grabbedNode = -1, this._colors = {
                background: 0,
                link: 0,
                node: 0,
                outline: 0,
                text: 0,
                accent: 0
            }, this._width = 0, this._height = 0, this.cameraOffset = new c(this.canvas.width, this.canvas.height).scale(.5), this.cameraScale = 1, this.hoveredNode = -1, this.grabbedNode = -1, this.resampleColors(), n(this, Vt, Bt).call(this, !0), this.width = this.canvas.width, this.height = this.canvas.height, this.autoResizeCanvas()
        }
        get cameraOffset() {
            return this._cameraOffset
        }
        set cameraOffset(t) {
            this._cameraOffset = t, n(this, $t, Gt).call(this, t, this.cameraScale)
        }
        get cameraScale() {
            return this._cameraScale
        }
        set cameraScale(t) {
            this._cameraScale = t, n(this, $t, Gt).call(this, this.cameraOffset, t)
        }
        get hoveredNode() {
            return this._hoveredNode
        }
        set hoveredNode(t) {
            this._hoveredNode = t, n(this, jt, Ut).call(this, t, this._grabbedNode)
        }
        get grabbedNode() {
            return this._grabbedNode
        }
        set grabbedNode(t) {
            this._grabbedNode = t, n(this, jt, Ut).call(this, this._hoveredNode, t)
        }
        get colors() {
            return this._colors
        }
        set colors(t) {
            this._colors = t, n(this, Yt, Kt).call(this, t)
        }
        get width() {
            return this._width
        }
        ...
        updateData(t) {
            this.graph = t, n(this, Vt, Bt).call(this)
        }
        sampleColor(t) {
            const e = document.createElement("div");
    ...
    Vt = new WeakSet, Bt = function(t = !1) {
        const {
            width: e,
            height: i
        } = this.view;
    ...
    }, jt = new WeakSet, Ut = function(t, e) {
        const i = {
    ...
    }, $t = new WeakSet, Gt = function(t, e) {
        this.worker.postMessage({
            type: "update_camera",
            cameraOffset: t,
            cameraScale: e
        })
    }, Yt = new WeakSet, Kt = function(t) {
        this.worker.postMessage({
            type: "update_colors",
            colors: t
        })
    ...
    var Qt = class {
            constructor(t, e) {
                this.elements = new Map, this._options = t, e ? this.replaceFeature(e) : this.setupFeatureContainer(), this.options.insertFeature(document.body, this.getElement(Qt.FEATURE_KEY)), this.onAfterMount()
            }
            ...
            getElementHierarchy() {
                return {
                    [Qt.FEATURE_KEY]: null,
                    [Qt.HEADER_KEY]: Qt.FEATURE_KEY,
                    [Qt.TITLE_KEY]: Qt.HEADER_KEY,
                    [Qt.CONTENT_KEY]: Qt.FEATURE_KEY
                }
            }
            createElement(t) {
                const e = document.createElement(t.type);
                if (t.className) {
                    const i = Array.isArray(t.className) ? t.className : [t.className];
                    e.classList.add(...i)
                }
                return t.id && (e.id = t.id), t.attributes && Object.entries(t.attributes).forEach((([t, i]) => {
                    e.setAttribute(t, i)
                })), e
            }
            getElement(t) {
            ...
            setupFeatureContainer() {
                const t = this.getElementDefinitions(),
                    e = this.getElementHierarchy();
                if (Object.entries(t).forEach((([t, e]) => {
                        this.elements.set(t, this.createElement(e))
                    })), Object.entries(e).forEach((([t, e]) => {
                        if (null === e) return;
                        const i = this.elements.get(t),
                            s = this.elements.get(e);
                        i && s && s.appendChild(i)
                    })), this._options instanceof S && this._options.displayTitle?.length > 0) {
                    const t = this.getElement(Qt.TITLE_KEY);
                    t && (t.innerText = this._options.displayTitle)
                }
                setTimeout((() => {
                    const t = this.getElement(Qt.FEATURE_KEY);
                    t?.classList.remove("hide")
                }), 0)
            }
            replaceFeature(t) {
                this.destroy();
                const e = this.getElementDefinitions(),
                    i = this.getElementHierarchy();
                this.elements.set(Qt.FEATURE_KEY, t), Object.entries(e).forEach((([e, s]) => {
                    if (e === Qt.FEATURE_KEY) return;
                    let n = t.querySelector(`.${Array.isArray(s.className)?s.className[0]:s.className}`);
                    if (!n) {
                        n = this.createElement(s);
                        const t = i[e];
                        if (t) {
                            const e = this.elements.get(t);
                            e?.appendChild(n)
                        }
                    }
                    this.elements.set(e, n)
                }))
            }
            onAfterMount() {}
            get options() {
        ...
        Zt = Qt;
    Zt.FEATURE_KEY = "feature", Zt.HEADER_KEY = "header", Zt.CONTENT_KEY = "content", Zt.TITLE_KEY = "title";
    var te = class extends Zt {
            ...
            initEvents() {
                ...
                function i(e) {
                    const i = t.graphRenderer.canvas.getBoundingClientRect(),
                        s = function(t) {
                            const e = Array.from(t.touches),
                                i = e.reduce(((t, e) => t + e.clientX), 0) / e.length,
                                s = e.reduce(((t, e) => t + e.clientY), 0) / e.length;
                            return new c(i, s)
                        }(e);
                    return new c(s.x - i.left, s.y - i.top)
                }
                let s = new c(0, 0),
                    ...
                    u = -1,
                    p = !1;
                const g = this.graphContainer,
                    f = this.graphRenderer;
                this.graphRenderer.canvas.addEventListener("pointerenter", (function(b) {
                    let v = 0,
                        w = !1;

                    function y(i) {
                        s = e(i), t.mouseWorldPos = f.vecToWorldspace(s), o = new c(s.x - n.x, s.y - n.y), n = s, -1 != f.grabbedNode && (a = new c(s.x - d.x, s.y - d.y)), h && -1 != f.hoveredNode && -1 == f.grabbedNode && f.hoveredNode != f.grabbedNode && (f.grabbedNode = f.hoveredNode), h && -1 == f.hoveredNode && -1 == f.grabbedNode || l ? f.cameraOffset = new c(f.cameraOffset.x + o.x, f.cameraOffset.y + o.y) : -1 != f.hoveredNode ? f.canvas.style.cursor = "pointer" : f.canvas.style.cursor = "default"
                    }

                    function E(e) {
                        if (1 == e.touches?.length) return w && (n = i(e), w = !1), void y(e);
                        if (2 == e.touches?.length) {
                            const a = m(e.touches[0]),
                                r = m(e.touches[1]);
                            s = i(e), o = new c(s.x - n.x, s.y - n.y), n = s;
                            const h = Math.sqrt(Math.pow(a.x - r.x, 2) + Math.pow(a.y - r.y, 2));
                            w || (w = !0, v = h, o = new c(0, 0), t.mouseWorldPos = c.Undefined, f.grabbedNode = -1, f.hoveredNode = -1);
                            const l = (h - v) / v;
                            t.scaleAround(f.vecToWorldspace(s), 1 + l, .15, 15), f.cameraOffset = new c(f.cameraOffset.x + o.x, f.cameraOffset.y + o.y), v = h
                        }
                    }
                    ...
                    function S(e) {
                        ...
                        const i = Date.now();
                        setTimeout((() => {
                            h && -1 != f.hoveredNode && Math.abs(a.x) <= 4 && Math.abs(a.y) <= 4 && i - r < 300 && t.navigateToNode(f.hoveredNode), h && -1 != f.grabbedNode && (f.grabbedNode = -1), 0 == e.button && (h = !1), "touch" == e.pointerType && u == e.pointerId && (u = -1, h = !1), 1 == e.button && (l = !1), p || (document.removeEventListener("mousemove", y), document.removeEventListener("touchmove", E))
                        }), 0)
                    }

                    function _(e) {
                        document.addEventListener("pointerup", S), t.mouseWorldPos = f.vecToWorldspace(s), a = new c(0, 0), 0 == e.button && (h = !0), "touch" == e.pointerType && -1 == u && (u = e.pointerId, h = !0), 1 == e.button && (l = !0), d = s, r = Date.now()
                    }
                    s = e(b), t.mouseWorldPos = f.vecToWorldspace(s), n = e(b), p = !0, document.addEventListener("mousemove", y), document.addEventListener("touchmove", E), g.addEventListener("pointerdown", _), g.addEventListener("pointerleave", (function e(i) {
                        setTimeout((() => {
                            p = !1, h || (document.removeEventListener("mousemove", y), document.removeEventListener("touchmove", E), t.mouseWorldPos = c.Undefined), g.removeEventListener("pointerdown", _), g.removeEventListener("pointerleave", e)
                        }), 1)
                    }))
            ...
            async generate(t) {
                ...
                for (const t of this.paths) {
                    ...
                    const n = s.links.map((t => $.getPathnameFromURL(t))).concat(s.attachments).concat(s.backlinks);
                    let o = [...new Set(n)];
                    o.push(t);
                    for (const t of o) {
                ...
                const s = Math.max(...e);
                this.radii = e.map((t => g(this.options.minNodeRadius, this.options.maxNodeRadius, Math.min(t / (.8 * s), 1)))), this.linkCount = this.linkSources.length
            }
            async showGraph(t) {
                this.paused = !0;
                let e = [];
                if (t) {
                    for (const i of t) {
                        ...
                        t?.backlinks && e.push(...t.backlinks), t?.links && e.push(...t.links.map((t => $.getPathnameFromURL(t)))), t?.attachments && e.push(...t.attachments)
                    }
                    e.push(...t)
                ...
                await this.generate(i), this.graphSim.init(this, s), this.graphRenderer ? this.graphRenderer.updateData(this) : this.graphRenderer = new Xt(this), this.fitToNodes(), this.eventsInitialized || (this.initEvents(), this.eventsInitialized = !0), this.paused = !1;
        ...
        ie = class extends Zt {
            constructor(t, e, i) {
                super(t, i), this.dependencies = e, this.updateContent()
            }
            regenerate() {
                this.updateContent()
            }
            updateDependencies(t, e = !0) {
                this.dependencies = t, e && this.regenerate()
            }
            modifyDependencies(t, e = !0) {
                t(this.dependencies), e && this.regenerate()
            }
            getDependencies() {
                return this.dependencies
            }
            updateContent() {
                const t = this.getElement(Zt.CONTENT_KEY);
                if (!t) return;
                for (; t.firstChild;) t.removeChild(t.firstChild);
                const e = this.getElement(Zt.FEATURE_KEY);
                !e?.isConnected && e && this.options.insertFeature(document.body, e), this.generateContent(t)
            }
            hide() {
                const t = this.getElement(Zt.FEATURE_KEY);
        ...
        ne = class extends ie {
            ...
            generateContent(t) {
                ...
                this.backlinks = e.backlinkPaths.map((e => new se(t, e)))
            }
        },
        oe = class extends ie {
            constructor(t) {
            ...
            generateContent(t) {
                ...
                for (const i of e.tags) {
                    ...
                    e.classList.add("tag"), e.setAttribute("href", `?query=tag:${i.replace("#","")}`), e.innerText = i, t.appendChild(e)
                }
                $.initializeLinks(t)
            }
        },
        ae = class extends ie {
            ...
            generateContent(t) {
                ...
                for (const i of e.aliases) {
                    ...
                    e.classList.add("alias"), e.innerText = i, t.appendChild(e)
                }
                return t
            }
        };
    window && window.location && (window.ObsidianSite = new class {
        constructor() {
            this.LinkHandler = $, this.LinkPreview = U, this.isLoaded = !1, this.isHttp = "file:" != window.location.protocol, this.fileTree = void 0, this.outlineTree = void 0, this.search = void 0, this.leftSidebar = void 0, this.rightSidebar = void 0, this.graphView = void 0, this.backlinkList = void 0, this.tags = void 0, this.aliases = void 0, this.onloadCallbacks = [], this.cachedWebpageDataMap = new Map, this.cachedFileDataMap = new Map, this.lastScreenWidth = void 0, this.isResizing = !1, this.checkStillResizingTimeout = void 0, this._deviceSize = "large-screen"
        }
        onDocumentLoad(t) {
        ...
        async onInit() {
            this.isHttp || (this.metadata = await this.loadWebsiteData(), this.metadata || (console.error("Failed to load website data."), this.metadata = new H, this.metadata.ignoreMetadata = !0)), await a((() => null != this.metadata), 16), console.log("Website init"), "file:" != window.location.protocol && await loadIncludes(), this.theme = new ee, this.bodyEl = document.body, this.horizontalLayout = document.querySelector("#main-horizontal"), this.centerContentEl = document.querySelector("#center-content");
            ...
            this.bodyEl.className += " " + this.metadata.bodyClasses, this.createLoadingEl(), t && (this.fileTree = new qt(t)), e && (this.outlineTree = new qt(e, this.metadata.featureOptions.outline.minCollapseDepth)), i && (this.leftSidebar = new Dt(i)), s && (this.rightSidebar = new Dt(s)), this.search = await (new At).init();
            const n = document.querySelector("meta[name='pathname']")?.getAttribute("content") ?? "unknown";
            if (this.entryPage = n, this.document = await new J(n), await this.document.loadChildDocuments(), await this.document.postLoadInit(), !ObsidianSite.metadata.ignoreMetadata && ObsidianSite.metadata.featureOptions.graphView.enabled && this.loadGraphView().then((() => this.graphView?.showGraph([n]))), this.initEvents(), U.loadPinnedPreviews(), this.onDocumentLoad((t => {
                    if (!ObsidianSite.metadata.ignoreMetadata) {
                        const e = t.isMainDocument && !ObsidianSite.metadata.ignoreMetadata && ObsidianSite.metadata.featureOptions.backlinks.enabled && "markdown" == t.documentType,
                            i = t.isMainDocument && !ObsidianSite.metadata.ignoreMetadata && ObsidianSite.metadata.featureOptions.tags.enabled && "markdown" == t.documentType,
                            s = t.isMainDocument && !ObsidianSite.metadata.ignoreMetadata && ObsidianSite.metadata.featureOptions.alias.enabled && "markdown" == t.documentType;
                        if (e) {
                            const e = t.info.backlinks?.filter((e => e != t.pathname));
                            this.backlinkList ? this.backlinkList?.modifyDependencies((e => {
                                e.backlinkPaths = t.info.backlinks ?? []
                            })) : this.backlinkList = new ne(t.info.backlinks ?? []), e && 0 != e.length ? this.backlinkList?.show() : this.backlinkList?.hide()
                        } else this.backlinkList?.hide();
                        if (i) {
                            const e = [];
                            ObsidianSite.metadata.featureOptions.tags.showInlineTags && t.info.inlineTags && e.push(...t.info.inlineTags), ObsidianSite.metadata.featureOptions.tags.showFrontmatterTags && t.info.frontmatterTags && e.push(...t.info.frontmatterTags), this.tags ? this.tags?.modifyDependencies((t => {
                                t.tags = e
                            })) : this.tags = new oe(e), 0 == e.length ? this.tags?.hide() : this.tags?.show()
                        } else this.tags?.hide();
                        if (s) {
                            const e = t.info.aliases;
                            this.aliases ? this.aliases?.modifyDependencies((t => {
                                t.aliases = e ?? []
                            })) : this.aliases = new ae(e ?? []), e && 0 != e.length ? this.aliases?.show() : this.aliases?.hide()
                        } else this.aliases?.hide()
                    }
                })), this.isHttp) {
                let t = this.document.pathname;
                "index.html" == t && (t = ""), history.replaceState({
                    pathname: t
                }, this.document.title, t)
            }
            this.isLoaded = !0, this.onloadCallbacks.forEach((t => t(this.document)))
        }
        initEvents() {
            window.addEventListener("popstate", (async t => {
                if (console.log("popstate", t), !t.state) return;
                const e = t.state.pathname;
                await ObsidianSite.loadURL(e, !1)
            }));
            const t = this;
        ...
        updateMetaTag(t, e) {
            let i = document.querySelector(`meta[name="${t}"], meta[property="${t}"]`);
            i || (i = document.createElement("meta"), t.startsWith("og:") ? i.setAttribute("property", t) : i.setAttribute("name", t), document.head.appendChild(i)), i.setAttribute("content", e)
        }
        async loadURL(t, e = !0) {
            const i = $.getHashFromURL(t),
                s = $.getQueryFromURL(t);
            if (t = $.getPathnameFromURL(t), console.log("Loading URL", t, i, s), s && s.startsWith("query=")) return void this.search?.searchParseFilters(s.substring(6));
            if (this.document.pathname == t) return i ? this.document.scrollToHeader(i) : new K("This page is already loaded."), this.document;
            ...
            let o = n.sourceHtml.querySelector("#outline");
            return o && (o = document.adoptNode(o), document.querySelector("#outline")?.replaceWith(o), ObsidianSite.outlineTree = new qt(o, this.metadata.featureOptions.outline.minCollapseDepth)), setTimeout((async () => {
                this.onloadCallbacks.forEach((t => t(n))), await n.show(), i && n.scrollToHeader(i)
            }), 100), n
        }
        async fetch(t) {
            if (t = $.getPathnameFromURL(t), this.isHttp || t.startsWith("http")) {
                const e = await fetch(t);
                return e.ok ? e : void console.error("Failed to fetch", t)
            } {
                const e = this.getFileData(t);
        ...
        documentExists(t) {
            return t = $.getPathnameFromURL(t), this.isHttp ? !!this.metadata.webpages[t] : !!this.getFileData(t)?.data
        }
        async loadWebsiteData() {
            if (!this.isHttp) {
                const t = this.getLocalDataFromId("website-metadata");
                return t ? H.fromJSON(JSON.stringify(t)) : void 0
            }
            try {
                const t = await fetch(x.libFolderName + "/metadata.json");
                if (t.ok) {
                    const e = await t.text();
                    return H.fromJSON(e)
                }
            } catch (t) {
                console.error("Failed to load website metadata.", t), new K("Failed to load website metadata.")
            }
        }
        async loadGraphView() {
            ...
            waitLoadScripts(["graph-render-worker", "graph-wasm"], (() => {
                ...
                console.log("scripts loaded"), Module.onRuntimeInitialized = () => {
                    console.log("Wasm loaded"), i()
                }, run(), setTimeout((() => {
                    null == e.graphView && i()
                }), 100)
            })), await a((() => null != this.graphView))
        }
        getLocalDataFromId(t) {
            const e = document.getElementById(t);
            if (e) return JSON.parse(decodeURI(atob(e.getAttribute("value") ?? "")))
        }
        getWebpageData(t) {
            if (!this.isHttp) {
                if (this.cachedWebpageDataMap.has(t)) return this.cachedWebpageDataMap.get(t);
                {
                    const e = this.getLocalDataFromId($.getFileDataIdFromURL(t));
                    return this.cachedWebpageDataMap.set(t, e), e
                }
            }
            if (this.metadata) {
        ...
        getFileData(t) {
            if (!this.isHttp) {
                ...
                {
                    const e = this.getLocalDataFromId($.getFileDataIdFromURL(t));
                    return this.cachedFileDataMap.set(t, e), e
                }
            }
            if (this.metadata) {
        ...
        onResize() {
            ...
            function e(e, i) {
                ...
                return s > e && s < i && null == t.lastScreenWidth || s > e && s < i && ((t.lastScreenWidth ?? 0) <= e || (t.lastScreenWidth ?? 0) >= i)
            }

            function i(e) {
                const i = window.innerWidth;
                return i > e && null == t.lastScreenWidth || i > e && (t.lastScreenWidth ?? 0) < e
            }
